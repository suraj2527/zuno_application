...
class _ProfileFlow extends StatelessWidget {
    ...
    switch (step) {
      ...
      case 7:
        return Obx(
          () => _buildListSelectionStep(
            'Looking for 💜',
            controller.lookingForOptions
                .map((e) => "${e['emoji']} ${e['title']}")
                .toList(),
            controller.lookingFor,
            controller.selectLookingFor,
          ),
        );
      case 8:
        return Obx(
          () => _buildListSelectionStep(
            ...
            isMulti: true,
            selectedItems: controller.selectedInterests.toList(),
          ),
        );
      case 9:
        return Obx(
      ...
      case 11:
        return Obx(
          () => _buildListSelectionStep(
            'Zodiac Sign 🌟',
            controller.zodiacOptions,
            controller.selectedZodiac,
            controller.selectZodiac,
          ),
        );
      case 12:
  ...
  // =========================
  Widget _buildListSelectionStep(
    String title,
    List<String> items,
    String? currentVal,
    ...
    return Column(
      ...
      children: [
        const _StepTitleBlock(
          ...
          subtitle: 'Upload at least 1 main photo to continue.',
        ),
        const SizedBox(height: 24),
        Obx(() {
          return Column(
